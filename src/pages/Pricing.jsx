...
const plans = [
  {
    ...
    icon: FlashIcon,
    name: "Starter",
    desc: "Essential billing and inventory tools for retail shops, grocery, and quick-service counters.",
    price: 399,
    features: [
      "Counter POS & Fast Billing",
      "Barcode Scanning & Product Catalog",
      "Thermal Receipt & Digital Invoices",
      "Multiple Payment Modes (Cash, UPI, Cards)",
      "Daily Sales & Expense Tracking",
      "Customer Khata & Ledger Management",
      "100% Offline-Ready Billing",
      "Cloud Backup & Mobile Access",
      "Single Counter / Branch Setup",
  ...
  },
  {
    ...
    name: "Growth",
    badge: "Most Popular",
    desc: "Complete smart POS for restaurants, cafes, dining outlets, and high-volume retail stores.",
    price: 599,
    everythingIn: "Everything in Starter, plus:",
    features: [
      "Cafe & Restaurant POS",
      "Table Management & Dine-in QR Ordering",
      "Kitchen Order Tickets (KOT) & Kitchen Display",
      "Recipe & Raw Material Inventory",
      "GST Invoicing & Tax Reports",
      "Multi-User Logins & Role Permissions",
  ...
  },
  {
    ...
    icon: Building02Icon,
    name: "Enterprise",
    desc: "All-in-one management suite for multi-branch chains, schools, hotels & large enterprise businesses.",
    price: "Custom",
    everythingIn: "Everything in Growth, plus:",
    features: [
      "Cafe & Restaurant POS",
      "Counter POS (Multi-Counter & Multi-Lane)",
      "School Management System & Campus ERP",
      "Complete Accounting Software & Tax Filing",
      "Hotel & Salon Management Software",
      "Centralized Multi-Branch Management",
      "Unlimited Locations, Staff & Terminals",
      "Custom API & Third-Party Integrations",
      "Dedicated Onboarding & Account Manager",
      "Advanced Security, Data Backup & 99.9% Uptime",
    ],
    cta: "Contact Sales",
