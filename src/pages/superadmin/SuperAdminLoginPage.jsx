...
import { ShieldUserIcon, Mail01Icon, LockPasswordIcon, ViewIcon, ViewOffIcon } from "hugeicons-react";
import { login, homePathForRole } from "../../lib/superadmin/useAuth";
    ...
    <div className="flex h-screen w-full items-center justify-center bg-(--color-canvas) px-4 text-(--color-text)">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="mt-3 text-xl font-semibold">Super Admin</h1>
          <p className="mt-1 text-sm text-(--color-text-muted)">Sign in to manage the platform</p>
        </div>
