...
import { SparklesIcon, StarIcon, Tick02Icon, ArrowRight02Icon } from "hugeicons-react";

const defaultTrialItems = [
  {
    title: "Full Premium Access",
    desc: "Every feature unlocked from day one — no gated tiers, no surprises.",
  },
  {
  ...
  },
  {
    ...
    desc: "If you love it, your chosen plan activates automatically after the trial at the listed price.",
  },
];
    ...
    <>
      <section className="px-4 pb-10 pt-16 md:pt-20">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h1 className="mt-4 text-4xl font-extrabold tracking-tight text-ink-900 md:text-5xl">
            {heading1}
            <br />
            <span className="italic text-brand-600">{heading2}</span>
          </h1>
      ...
      <section className="px-4 pb-24">
        ...
        >
          ...
          <p className="mt-4 max-w-2xl text-ink-700">{trialDesc}</p>
          ...
          <div className="mt-8 border-t border-emerald-100 pt-6 text-sm text-ink-700">
            ...
            Sign up, choose a plan, and get started. Subscriptions are
